                    ...
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        >
                            ...
                            <div>
                                ...
                                />
                                <p
                                    v-show="validationInputs.email"
                                    class="mt-2 text-sm text-red-600 dark:text-red-500"
                                >
                                    <span class="font-medium"></span> ايميل غير
                                    صالح
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                />
                                <p
                                    v-show="validationInputs.rePassword"
                                    class="mt-2 text-sm text-red-600 dark:text-red-500"
                                >
                                    <span class="font-medium"></span> كلمة السر
                                    غير متطابقة
                                </p>
                            </div>
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <p
                                            class="mb-2 text-sm text-gray-500 non:text-gray-400"
                                        >
